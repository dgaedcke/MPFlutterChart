...
class OpsScaleGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  }) : super(debugOwner: debugOwner, supportedDevices: <PointerDeviceKind>{});
    ...
    if (_state == _ScaleState.started) {
      if (onEnd != null) {
        ...
        if (_isFlingGesture(velocity)) {
          final Offset pixelsPerSecond = velocity?.pixelsPerSecond ?? Offset.zero;
